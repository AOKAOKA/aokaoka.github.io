...
$.ajax({
    ...
    data: {
        key: 'BRHBZ-A5GC4-GGSU5-FUZIG-AJWAH-QFB2Y',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(1101271649, 19.938232, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
