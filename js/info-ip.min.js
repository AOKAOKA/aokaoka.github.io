...
const addStyles = () => {
  ...
  , fetchIpInfo = async () => {
    ...
    showLoadingSpinner();
    try {
        const _0x50ab59 = await fetch('https://api.76.al/api/ip/query?key=d9dl7H3NzOwR0hO7Pz3PtyB2W5');
        if (!_0x50ab59['ok'])
